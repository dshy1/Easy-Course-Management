            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Nome do aluno" value="{{isset($dados->name) ? $dados->name : ''}}" checked="checked" name="nome">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-3">
                    ...
                    <input type="text" name="bairro" class="form-control" placeholder="Pinheiros">
                </div>
